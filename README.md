...
- [Howto/Step by step instructions](#howto)
  ...
  7. [Handlebars partials and helpers](#handlebars-partials-helpers)
  8. [Advanced Sass Techniques (BEM)](#sass-bem)
...
All the user needs to know is how to install a node module, create folders and files, write Markdown or HTML, add CSS styling and publish the result on GitHub.
...
- CSS from [Sass](https://sass-lang.com/) compilation contains autoprefixing for the recent 2 browsers generations.
...
- Complete `README.md`.
- Ability to paginate or lazy load blog entries (maybe by sub folders in the `blog` folder).
...
This copies the skeleton into the folder, builds initial static page and starts the webserver and watcher.
...
That is not a lot of biolerplate!
...
- [highlight.js](https://github.com/highlightjs/highlight.js/) - Syntax highlighting for Markdown code blocks
